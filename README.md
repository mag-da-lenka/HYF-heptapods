<!DOCTYPE html>
<html>
<!-- Dear Humans, I know it's a HTML box but I prefer to keep my HTML and CSS together, I hope you don't mind -->

<head>
  <meta charset="utf-8">
  <title>My 1st codepen: HTML CSS</title>
  <style>
    body {
      background-color: rgb(234, 252, 249);
    }
    ...
    #header {
      ...
      font-weight: bold;
      background-color: rgb(247, 185, 27);
      padding: 6px;
      clear: both;
    }
...
<body>
  ...
  <!-- Hello Humans, I will try to fix he picture, but I will link a small gallery so that you will see it anyway. Useful link: https://www.pagetutor.com/html_tutor/missing.html --> 
        <p>
        <img id="dziubdziaksy" src="https://github.com/mag-da-lenka/HYF-heptapods/blob/master/IMG_20190616_222745.jpg" width="300"> 
        <br> Heptapodlings 
        </p> 
  </a>
  ...
  <p class="important">IMPORTANT: I'm going to write a simple page as best as I can. I had the priviledge of getting sick a few days ago so I was not able to google all the cool stuff but I have completed the Khan Academy's Intro to HTML and CSS. I am starting to build the
